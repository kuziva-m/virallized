...
const LandingPage = () => {
  ...
  return (
    <>
      <SEO
        title="50% Off Instagram Growth Services | Virallized"
        description="Claim 50% off your first month with Virallized and grow your Instagram with real, targeted followers through safe organic promotion."
        path="/50-off"
      />
