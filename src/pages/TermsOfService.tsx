...
const TermsOfService = () => {
  return (
    <>
      <SEO
        title="Terms of Service | Virallized"
        description="Read the Virallized Terms of Service, including account rules, subscriptions, refunds, acceptable use, and service conditions."
        ...
        <main className="container mx-auto px-6 py-12 lg:py-20 max-w-4xl">
          <div className="bg-white rounded-3xl p-8 md:p-12 lg:p-16 border border-slate-200 shadow-sm">
            ...
            <div className="text-sm md:text-base text-slate-600 leading-relaxed space-y-6">
              <p>
                This Internet Web Site Terms and Conditions of Use Agreement
                (the "Terms of Use") is between the party “signing up” and/or
                using The Site ("you") and Virallized ("we" or "us" and
                collectively the "Company" or "Virallized"). You should
                carefully read the Terms of Use before using The Site. By using
                The Site you agree to be bound by the terms and conditions of
                use set forth in the Terms of Use. This is a legally binding
                agreement. If you do not agree with the Terms of Use you should
                not use The Site and must leave The Site.
              </p>
              <p>
                We agree to provide you access to The Site in accordance with
                the Terms of Use.
              </p>
              ...
              <ol className="list-decimal pl-5 space-y-4 font-medium text-slate-700">
                ...
                <li>
                  ...
                  Virallized if your account gets banned, locked up, and any
                  other action that Instagram/Facebook does to your account on
                  behalf of your actions or using Virallized to build and grow
                  your profile. We do not guarantee the amount of followers you
                  will receive and if they will be real individuals. We also do
                  not guarantee the connection to be stable or permanently
                  connected to Instagram or its API at any given time.
                </li>
                <li>
                ...
                <li>
                  You agree to contact customer service for a refund if
                  necessary. Virallized reserves the right to give you a full or
                  prorated refund based on their own discretion. You also agree
                  not to file any fraudulent claim to chargeback or dispute
                  charges from Virallized. In the event that Virallized is no
                  longer able to provide service, Virallized reserve the rights
                  to not give a refund and also shut down our service at any
                  time.
                </li>
                <li>
                  You agree to use The Site in a manner consistent with the
                  Terms of Use and all applicable rules and regulations. You
                  acknowledge that you have read the Terms of Use and that you
                  accept the terms thereof. You agree to read these terms of use
                  carefully before using The Site. If you do not agree to the
                  Terms of Use, you may not access or otherwise use The Site.
                </li>
                <li>
                  You accept that The Site is provided on an "as is, as
                  available" basis.
                </li>
                <li>
                  ...
                  <span className="uppercase">
                    All articles and material displayed by us on the site are
                    for information only, are no substitute for specific advice,
                    and are in no manner to be considered legal advice or other
                    licensed professional advice or a substitute therefor. For
                    specific legal advice regarding your particular
                    circumstances, you must retain legal counsel.
                  </span>{" "}
                  ...
                  acknowledge that any reliance upon any such materials,
                  opinion, advice, statement, memorandum, or information shall
                  be at your sole risk. the Company reserves the right, in its
                  sole discretion, to correct any errors or omissions in any
                  portion of The Site.
                </li>
                <li className="uppercase">
                  Your access to and use of the site may be terminated at any
                  time for any reason or for no reason by you or by us.
                </li>
                <li className="uppercase">
                  We may, subject to and in accordance with our privacy policy
                  for marketing and other purposes, collect, process and
                  transmit certain data obtained from and about you in the
                  course of your accessing the site. By agreeing to these terms,
                  you agree to such data being so used and further agree that it
                  may be transmitted to others whether or not within the
                  Philippines or Australia in accordance with our privacy policy
                  and under applicable privacy and data protection legislation.{" "}
                ...
                <li>
                  ...
                  compilation, pursuant to U.S. & AU copyright laws,
                  international conventions, and other copyright laws. You are
                  authorized to download one copy of the material displayed or
                  performed on The Site ("Content") on one computer for your
                  personal, non-commercial use only but you may not in so doing
                  remove or amend any trademark, copyright or other proprietary
                  notice. All materials contained on The Site are protected by
                  copyright, and are owned or controlled by the Company or the
                  party credited as the provider of the Content. You will abide
                  by any and all additional copyright notices, information, or
                  restrictions contained in any Content on The Site. Permission
                  is given to view the material on these web pages and save that
                  material only for your personal reference. Copying or storing
                  of any Content for other than personal, non-commercial use is
                  expressly prohibited without the prior written permission from
                  the Company or the copyright holder identified in the
                  individual Content's copyright notice. <br />
                  <br />
                  ...
                  restrict your access to parts or all of The Site without
                  notice or liability.
                </li>
                <li>
                  ...
                  responsibility and liability for the Postings or for any
                ...
                <li>
                  ...
                  through The Site any materials which (i) restrict or inhibit
                  any other user from using and enjoying The Site, (ii) are
                  unlawful, threatening, abusive, libelous, defamatory, obscene,
                  vulgar, offensive, pornographic, profane, sexually explicit or
                  indecent, (iii) constitute or encourage conduct that would
                  constitute a criminal offense, give rise to civil liability or
                  otherwise violate law, (iv) violate, plagiarize or infringe
                  the rights of third parties including, without limitation,
                  copyright, trademark, patent, rights of privacy or publicity
                  or any other proprietary right, (v) contain a virus or other
                  harmful component, (vi) contain any information, software or
                  other material of a commercial nature, (vii) contain
                  advertising of any kind, or (viii) constitute or contain false
                  or misleading indications of origin or statements of fact; and
                ...
                <li>
                  ...
                  inappropriate, (c) criminal or (d) otherwise in breach of
                  these Terms of Use. We do not and cannot review all materials
                  posted to The Site by users, and we are not responsible for
                  any such materials posted by users. However, we reserve the
                  right at all times to disclose any information as necessary to
                  satisfy any law, regulation or government request, or to edit,
                  refuse to post or to remove any information or materials, in
                  whole or in part, that in the sole discretion of The Company
                  are objectionable or in violation of these Terms of Use.
                </li>
                <li>
                  You hereby represent and warrant that you have all necessary
                  rights in and to all Postings you provide and all material
                  they contain and that such Postings shall not infringe any
                  ...
                  "Communications") to The Site, you hereby grant to The
                  Company, subject to our privacy policy, a perpetual,
                  worldwide, irrevocable, unrestricted, non-exclusive, royalty
                  free license to use, copy, license, sublicense, adapt,
                  distribute, display, publicly perform, reproduce, transmit,
                  modify, edit and otherwise exploit such Communications, in all
                  media now known or hereafter developed. You hereby waive all
                  rights to any claim against The Company for any alleged or
                  actual infringements of any proprietary rights, rights of
                  privacy and publicity, moral rights, and rights of attribution
                  in connection with such Communications.
                </li>
                <li>
                  You acknowledge that transmissions to and from The Site are
                  not confidential and your Communications may be read or
                  intercepted by others. Any unprotected e-mail communication
                  over the Internet is subject to possible interception or loss,
                  is not confidential and is also subject to possible
                  alteration. We are not responsible for and will not be liable
                  to you or any third party for damages in connection with an
                  e-mail sent by you to us or an e-mail sent by us to you, or
                  anyone you designate, at your request. Violators of this
                  section who use our services for any illegal purpose including
                  but not limited to repeated unwanted emails or "Spam," may be
                  prosecuted to the full extent of the law. You acknowledge that
                  by submitting Communications to The Company, no confidential,
                  fiduciary, contractually implied or other relationship is
                  created between you and The Company other than pursuant to
                  these Terms of Use and any subsequent written agreement
                  entered into with The Company.
                </li>
                <li className="uppercase">
                  The Site, including all content, software, functions,
                  materials and information made available on or accessed
                  through the site, is provided "as is, as available." To the
                  fullest extent permissible by law. The Company and its
                  subsidiaries and affiliates make no representation or
                  warranties of any kind whatsoever for the content on the site
                  or the materials, information and functions made accessible by
                  the software used on or accessed through the site, for any
                  products or services or hypertext links to third parties or
                  for any breach of security associated with the transmission of
                  sensitive information through the site or any linked site.
                  Further, The Company and its subsidiaries and affiliates
                  disclaim any express or implied warranties, including, without
                  limitation, non-infringement, merchantability or fitness for a
                  particular purpose. The Company does not warrant that the
                  functions contained in the site or any materials or content
                  contained therein will be uninterrupted or error free, that
                  defects will be corrected, or that the site or the server that
                  makes it available is free of viruses or other harmful
                  components. The Company and its subsidiaries and affiliates
                  shall not be liable for the use of the site, including,
                  without limitation, the content and any errors contained
                  therein. Further, in no event will The Company be liable for
                  any loss of profits, business, use of data or for indirect,
                  special, incidental or consequential damages of any kind
                  whether based in contract, negligence or other tort. To the
                  fullest extent permitted by applicable laws, we on behalf of
                  our employees, agents, suppliers, and contractors, disclaim
                  and exclude liability for any losses and expenses of whatever
                  ...
                  the site or any web site with which it is linked. You assume
                  total responsibility for establishing such procedures for data
                  back up and virus checking as you consider necessary.
                </li>
                <li>
                  You hereby agree to indemnify, defend and hold The Company,
                  ...
                  of any breach by you of these Terms of Use or the foregoing
                ...
                <li>
                  Where we provide hypertext links from or to third party sites
                  we do so for convenience and information purposes only. We do
                  not review, endorse, approve or control, and are not
                  responsible for any sites linked from or to the Website, the
                  content of those sites, the third parties named therein, or
                  their products, resources or services. Linking to any other
                  site is at your sole risk and we will not be responsible or
                  liable for any damages in connection with linking, and we
                  accept no liability nor make any endorsement or approval of
                  the same.
                </li>
                <li>
                  ...
                  Notification of changes in these Terms of Use will be posted
                  on The Site.
                </li>
                <li>
                ...
                <li>
                  The Site, any information provided from it and the Terms of
                  Use are given and made in Australia.{" "}
                  <span className="uppercase">
                    This terms of use agreement shall be governed by and
                    construed in accordance with the laws of Australia, without
                    regard to conflicts of laws provisions. Sole and exclusive
                    jurisdiction for any action or proceeding arising out of or
                    related to this terms of use agreement shall be an
                    appropriate state or federal court located in Australia.
                  </span>
                </li>
                <li>
                  Pursuant to Federal law we are providing the following
                  separate written statement for your review and to acknowledge
                  receipt thereof, which, pursuant to the requirements of
                  Federal law, will also be delivered with any contract entered
                  into with The Company.
                </li>
                <li>
                  The terms and conditions of use in this Terms of Use are
                  subject to change at any time. You should review the Terms of
                  Use regularly for any changes.
                </li>
              </ol>
              ...
              <p>
                ...
                payment information and process your payment. We allow you to
                make purchases using the following third party payment
                processors: PayPal and Stripe. We are not responsible for the
                collection, use, sharing or security of your billing information
                by these third party payment processors. The following payment
                method(s) are accepted by the third party payment processors:
                American Express, MasterCard, and Visa.
              </p>
              <p>
                You hereby represent and warrant that you have the legal right
                to use the payment method(s) in connection with any purchase and
                that the information that you supply to us and to the third
                party payment processor(s) is true, correct and complete.
              </p>
              ...
              <p>
                We offer refunds on purchases made of the services offered on
                our Website. To qualify for a refund, you must submit your
                request to us within 48 hours of your purchase date by
                contacting us and via the Website. We offer refunds on any
                purchases of the services offered on our Website for the
                following reason(s) only: the good, digital product or service
                failed to meet the warranties, if any and the wrong product or
                service was provided. Please note that we do not offer refunds
                for any other reasons other than those listed above.
              </p>
              ...
              <p className="uppercase">
                ...
                fitness for a particular purpose or use) shall apply to any
                items or services displayed or sold on this website, whether
                arising by law, course of dealing, course of performance, usage
              ...
              <p>
                ...
                Service as it relates to your purchase shall be to pursue
                dispute resolution as provided in the “governing law,
                severability, dispute resolution, venue and class action waiver”
                section below. These remedies intended to be your sole and
                exclusive remedies for any breach of this Terms of Service as it
              ...
              <p className="uppercase">
                When you purchase a subscription on the website, your
                subscription will automatically renew every month. We will
                automatically renew your subscription by using the payment
                method on file until you cancel your subscription.
              </p>
              <p className="uppercase">
                You may cancel the automatic renewals of your subscription via
                the following means:
              </p>
              ...
              <p className="uppercase">
                Please note that you will no longer receive the items or
                services provided by the subscription on your cancellation
                effective date.
              </p>
              <p className="uppercase">
              ...
              <p>
                When you create an account on our Website, you guarantee that
                you are 18 years of age or older and that the information that
              ...
              <p>
                ...
                password is with our Website or a third party service. You must
              ...
              <p>
                ...
                sole discretion. You can terminate your account by contacting us
                or through their account on the Website.
              </p>
              ...
              <p>
                ...
                comment or content. When you make a comment or upload any
                content onto this Website, you agree that such comment or
                content may be viewed by other parties and it is your
                responsibility to ensure that the comment or content does not
                contain any confidential or proprietary information. You are
                also responsible for ensuring that your content or comment does
                not violate any laws, rules or regulations. We reserve the right
                to remove any content or comment at any time in our sole
                discretion.
              </p>
              <p>
              ...
              <ul className="list-disc pl-5 space-y-2 font-medium text-slate-700">
                ...
                <li>
                  Content advertising products or services without our
                  permission;
                </li>
              ...
              <p>
                ...
                applicable laws, rules, regulations and these Terms at all
                times. The following is a non-exhaustive list of prohibited uses
                of this Website. You agree that you will not perform any of the
              ...
              <ul className="list-disc pl-5 space-y-2 font-medium text-slate-700">
                ...
                <li>
                  Using any manual process or means to monitor or copy any of
                  the material on this Website or for any other unauthorized
                  purpose;
                </li>
                <li>
              ...
              <p className="uppercase">
                This website are provided “as is.” No warranty, express or
              ...
              <p>
                ...
                inaccuracies of the information, products or services provided
                on this Website. We may experience delays in updating
                information on this Website and in our advertising on other
                websites. The information, products and services found on the
                Website may contain errors or inaccuracies or may not be
                complete or current. Products or services may be incorrectly
                priced or unavailable. We expressly reserve the right to correct
                any pricing errors on our Website. The inclusion or offering of
                any product or service on this Website does not constitute an
              ...
              <p className="uppercase">
                ...
                out of, relating to or in any way connected with your access to,
                display of or use of this website or with the delay or inability
                to access, display or use this website, including but not
                limited to your reliance upon opinions or information appearing
                on this website; any computer viruses, information, software,
                linked websites operated by third parties, products or services
                obtained through this website, whether based on a theory of
                negligence, contract, tort, strict liability, consumer
                protection statutes or otherwise, even if Virallized has been
                advised of the possibility of such damages.
              </p>
              <p className="uppercase">
                This limitation of liability reflects the allocation of risk
                between you and us. The limitations specified in this section
                will survive and apply even if any limited remedy specified in
                these terms of use is found to have failed of its essential
                purpose. The limitations of liability provided in these terms of
                use inure to the benefit of Virallized.
              </p>
              ...
              <p>
                ...
                third parties and not by us. We provide such hyperlinks for your
                ...
                precautions to ensure that whatever links you click on or
                software that you download, whether from this Website or other
                websites or applications, is free of such items as viruses,
                worms, trojan horses, defects and other items of a destructive
                nature. Our inclusion of hyperlinks to such websites does not
              ...
              <p>
                ...
                pictures, information, data, software, sound files and
                arrangement thereof (collectively, “Content”) are the
                proprietary property of Virallized and are either registered
                trademarks, trademarks or otherwise protected intellectual
                property of Virallized or third parties in the United States
              ...
              <p>
                ...
                Website infringes on the copyright, trademark or other
              ...
              <p>
                ...
                properly filled out or is incomplete. You may be held
                accountable for damages, including but not limited to costs and
                attorneys’ fees for any misrepresentation or bad faith claims
                regarding the infringement of your intellectual property rights
              ...
              <p>
                ...
                <span className="uppercase">
                  ...
                  the Uniform Commercial Code, nor Incoterms.
                </span>
              </p>
              <p>
                ...
                agreement between you and us regarding our Website, and
                supersede and replace any prior agreements we might have had
                with you regarding the Website.
              </p>
              <p>
                Any controversy or claim arising out of or relating to these
                Terms including but not limited to the interpretation or breach
                thereof shall be resolved in a court of competent jurisdiction
              ...
              <p>
                ...
                at any time. We will notify you immediately of making any
                changes to these Terms of Service via by posting the updated
                terms of service to this website and via an email campaign.
              </p>
