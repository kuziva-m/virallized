        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 lg:p-16 border border-slate-200 shadow-sm">
          ...
          <div className="text-sm md:text-base text-slate-600 leading-relaxed space-y-6">
            <p>
              ...
              carefully before using the virallized.com Website (the "Website")
              operated by Virallized, a(n) Sole Proprietorship formed in New
              York, United States ("us," "we," "our") as this Privacy Policy
              contains important information regarding your privacy and how we
            ...
            <h2 className="text-xl md:text-2xl font-black text-slate-900 mt-12 mb-4">
              ...
              how we use this information, what happens if we don't have it, and
            ...
            <ul className="list-disc pl-5 space-y-2 font-medium text-slate-700">
              ...
              <li>
                ...
                personal information from public networks such as the internet.
              </li>
            </ul>
            ...
            <p>
              Depending upon where you reside, you may have the following rights
            ...
            <p>
              ...
              the following information with your request: Name; Email address.
            </p>
            <p>
            ...
            <p>
              ...
              request(s), we will provide you with the reasons for such denials.
            </p>
            ...
            <p>
              ...
              filling out this form or calling 1-800-282-1376.
            </p>
            ...
            <p>
              ...
              information may be processed in a country outside of Canada and it
              may be accessible to law enforcement authorities and national
